...
and `design`, respectively, in the SoSci Survey data set.
...
As the experiment is divided into three sessions, 40 out of the 120 stimuli
(30 excerpts × 4 conditions) are presented in each session.
