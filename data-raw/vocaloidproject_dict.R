  ...
  tibble::add_case(
    tibble::tibble(
      ...
      ja = paste0(
        ...
        "各セッションは、参加者ご自身のことや音楽経験に関する質問から始まり、その後合計40の楽曲の抜粋を評価していただきます。回答に正解や不正解はありません。",
        "すべての曲の抜粋に注意深くお聴きいただく必要があります。",
        "これを怠った場合、実験を終了し、PROLIFIC（プロリフィック）に戻していただくこととなります。その場合、研究から除外されます（<q>拒否</q>）。</p>",
        "<p>",
        "もしすべてのセッションを無事に完了した場合、ボーナスが支払われます。",
        "</p>",
        "<p>ご参加は任意です。参加条件は、<b>18歳以上で、母語が日本語であること</b>です。",
        "ご参加はいつでも理由を問わず中止することができ、何ら不利益はありません。途中で中止された場合、提供いただいたデータは削除されます。</p>",
        "<p>アンケートで取得したすべての情報は機密として扱われ、匿名化されます。つまり、個人が特定されることは一切ありません。",
        "データの収集および処理は、名前や個人を特定できる情報なしで行われます。",
        "匿名化されたデータは基礎研究に利用され、学術誌への掲載や学会での発表に使用されるほか、<q>オープンサイエンス</q>、すなわち科学研究の透明性と再現性を支援するために、公開データベースでも利用可能とされます。</p>",
        "<p>お問い合わせに、研究責任者コックス氏 <a href='mailto:cox.cathy@kunitachi.ac.jp'>cox.cathy@kunitachi.ac.jp</a> までご連絡ください。</p>"
      )
    )
  ) |>
  tibble::add_case(
