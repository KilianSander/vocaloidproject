...
HALT_dict <-
  ...
  #     "AGAIN", "",
      ...
      "DEVICE_PROMPT", "<p>音声を出力するため、どれのデバイスを使用しますか。</p><p>例： スマートフォンから再生される音声をイヤーホンで聴いている場合は、「ヘッドホン」を選択してください。</p><p>ご使用のデバイスに最も当てはまる選択肢を選んでください。</p>",
  #     "INTRO_TEXT", "",
  #     "PAGE_COUNTER", "",
  #     "SCC_PROMPT_HP", "",
  #     "SCC_PROMPT_LS", "",
