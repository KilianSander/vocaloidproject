  ...
  tibble::add_case(
    tibble::tibble(
      ...
      ja = paste0(
        ...
        "各セッションは、参加者ご自身のことや音楽経験に関する質問から始まり、その後合計40の楽曲の一部を評価していただきます。回答に正解や不正解はありません。",
        "すべての音楽サンプルを集中して注意深くお聞きいただくことが重要です。",
        "そうしなかった場合、実験は途中で終了し、PROLIFIC（プロリフィック）に戻されてしまいます。</p><p>", # additional line break (compared to de and en)
        "この場合、研究からは除外され、今回のセッションに対する報酬は支払われず、次回以降のセッションにも参加することはできません。</p>",
        "<p>",
        "３つすべてのセッションを完了した場合には、追加でボーナス報酬が支払われます。",
        "</p>",
        "<p>研究へのご参加は任意です。参加条件は、<b>18歳以上で、母語が日本語であること</b>です。",
        ...
        "<p>ご不明点やお問い合わせは、研究責任者保子英之<a href='mailto:hhoshi@fc.ritsumei.ac.jp'>hhoshi@fc.ritsumei.ac.jp</a> までご連絡ください。</p>"
      )
    )
  ) |>
  tibble::add_case(
