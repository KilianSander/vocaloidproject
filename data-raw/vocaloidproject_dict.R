  ...
  tibble::add_case(
    tibble::tibble(
      ...
      ja = paste0(
        ...
        "すべての曲を集中してお聴きください。",
        "これを怠った場合、実験は途中で終了し、PROLIFIC（プロリフィック）に戻されてしまいます。この場合、研究からは除外され、報酬をお支払いすることはできません。</p>", # （拒否）
        "<p>",
        "もしすべてのセッションを無事に完了した場合、ボーナスが支払われます。",
        "</p>",
        ...
        "<p>ご不明点やお問い合わせは、研究責任者コックス<a href='mailto:cox.cathy@kunitachi.ac.jp'>cox.cathy@kunitachi.ac.jp</a> までご連絡ください。</p>"
      )
    )
  ) |>
  tibble::add_case(
